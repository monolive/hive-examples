...
def main():
	gen_file_2(1,500000000,166666666)
	gen_file_2(500000001,1000000000,166666666)
	gen_file_2(1000000001,1500000000,166666666)
	gen_file_2(1500000001,2000000000,166666666)
	gen_file_2(2000000001,2500000000,166666666)
	gen_file_2(2500000001,3000000000,166666670)

def gen_file_2(min,max,amount):
